...
- **부위별 아이템** — 머리(캡 · 비니 · 왕관 · 헤드폰), 눈(안경 · 선글라스), 목(목도리 · 목걸이), 손(마이크 · 응원봉), 리본(무료), 몸 색(기본 · 민트 · 포도 · 복숭아 · 하늘 · 레몬), 배경(민트 · 노을 · 하늘 · 밤 · 노랑 · 분홍 · 라벤더 · 구름)
- 같은 부위는 하나만, 부위가 다르면 겹쳐 입습니다. 격자에서 누르면 바로 입어 보고, 마음에 들면 카드의 **N 사기**로 산 뒤 **이대로 저장**하면 끝. 기본 쏭나물은 리본이 없고, 리본은 달고 싶은 사람만 답니다.
